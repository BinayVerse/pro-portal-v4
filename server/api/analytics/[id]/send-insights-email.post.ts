...
import { generateInsightsEmailHTML } from "../../../utils/emailTemplates";
...
export const sendInsightsEmail = async (
  ...
  try {
    ...
    const htmlBody = generateInsightsEmailHTML(insightsData, period);
    ...
    logError('Error sending insights email:', error);
  }
};
