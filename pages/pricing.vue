      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-300 max-w-3xl mx-auto">
            Choose the plan that fits your needs. All plans include unlimited documents and 24/7 support.
          </p>
        </div>

        <!-- Pricing Grid -->
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div v-for="plan in plans" :key="plan.id" class="card relative" :class="plan.popular ? 'ring-2 ring-primary-500' : ''">
