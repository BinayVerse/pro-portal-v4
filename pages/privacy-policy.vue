  ...
  <div id="main">
    <section class="landing-inner-page">
      <div class="landing-inner-wrap">
        ...
        <h2 class="font-semibold text-2xl mt-8 text-white">Interpretation and Definitions</h2>
        <h3 class="font-bold text-white">Interpretation</h3>
        <p class="text-gray-300">
          The words of which the initial letter is capitalized have meanings defined under the
          following conditions. The following definitions shall have the same meaning regardless of
          whether they appear in singular or in plural.
        </p>
        <h3 class="font-bold mt-8 text-white">Definitions</h3>
        <p class="text-gray-300">For the purposes of this Privacy Policy:</p>
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <p>
              <strong class="text-white">Account</strong> means a unique account created for You to
              access our Service or parts of our Service.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">Affiliate</strong> means an entity that controls, is
          ...
          <li>
            <p>
              <strong class="text-white">Business</strong>, for the purpose of CCPA/CPRA, refers to
          ...
          <li>
            <p>
              <strong class="text-white">CCPA</strong> and/or
              <strong class="text-white">CPRA</strong> refers to the California Consumer Privacy Act
          ...
          <li>
            <p>
              <strong class="text-white">Company</strong> (referred to as either &quot;the
              Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement)
              refers to provento.ai, 6200 Stoneridge Mall Rd Suite 300 Pleasanton CA 94588.
            </p>
            <p class="text-gray-300">
          ...
          <li>
            <p>
              <strong class="text-white">Consumer</strong>, for the purpose of the CCPA/CPRA, means
              a natural person who is a California resident. A resident, as defined in the law,
          ...
          <li>
            <p>
              <strong class="text-white">Cookies</strong> are small files that are placed on Your
              computer, mobile device or any other device by a website, containing the details of
              Your browsing history on that website among its many uses.
            </p>
          </li>
          <li>
            <p><strong class="text-white">Country</strong> refers to: California, United States</p>
          </li>
          <li>
            <p>
              <strong class="text-white">Data Controller</strong>, for the purposes of the GDPR
              (General Data Protection Regulation), refers to the Company as the legal person which
          ...
          <li>
            <p>
              <strong class="text-white">Device</strong> means any device that can access the
              Service such as a computer, a cellphone or a digital tablet.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">Do Not Track</strong> (DNT) is a concept that has been
              promoted by US regulatory authorities, in particular the U.S. Federal Trade Commission
              (FTC), for the Internet industry to develop and implement a mechanism for allowing
              internet users to control the tracking of their online activities across websites.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">GDPR</strong> refers to EU General Data Protection
              Regulation.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">Personal Data</strong> is any information that relates to
              an identified or identifiable individual.
            </p>
            <p class="text-gray-300">
              For the purposes of GDPR, Personal Data means any information relating to You such as
          ...
          <li>
            <p>
              <strong class="text-white">Service Provider</strong> means any natural or legal person
              who processes the data on behalf of the Company. It refers to third-party companies or
              individuals employed by the Company to facilitate the Service, to provide the Service
          ...
          <li>
            <p>
              <strong class="text-white">Usage Data</strong> refers to data collected automatically,
          ...
          <li>
            <p>
              <strong class="text-white">Website</strong> refers to provento.ai, accessible from
              <a
                href="https://www.provento.ai"
                rel="external nofollow noopener"
                target="_blank"
                class="text-primary-400 hover:text-primary-300"
                >https://www.provento.ai</a
              >
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">You</strong> means the individual accessing or using the
        ...
        <h2 class="font-semibold text-2xl mt-8 text-white">
          Collecting and Using Your Personal Data
        </h2>
        <h3 class="font-bold mt-8 text-white">Types of Data Collected</h3>
        <h4 class="font-semibold mt-8 text-white">Personal Data</h4>
        <p class="text-gray-300">
        ...
        <h4 class="font-semibold mt-8 text-white">Usage Data</h4>
        <p class="text-gray-300">Usage Data is collected automatically when using the Service.</p>
        <p class="text-gray-300">
        ...
        <h4 class="font-semibold mt-8 text-white">Tracking Technologies and Cookies</h4>
        <p class="text-gray-300">
        ...
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <strong class="text-white">Cookies or Browser Cookies.</strong> A cookie is a small file
          ...
          <li>
            <strong class="text-white">Web Beacons.</strong> Certain sections of our Service and our
        ...
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <p><strong class="text-white">Necessary / Essential Cookies</strong></p>
          ...
          <li>
            <p><strong class="text-white">Cookies Policy / Notice Acceptance Cookies</strong></p>
          ...
          <li>
            <p><strong class="text-white">Functionality Cookies</strong></p>
            <p>Type: Persistent Cookies</p>
            <p>Administered by: Us</p>
            <p>
        ...
        <h3 class="font-bold mt-8 text-white">Use of Your Personal Data</h3>
        <p class="text-gray-300">The Company may use Personal Data for the following purposes:</p>
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <p>
              <strong class="text-white">To provide and maintain our Service</strong>, including to
              monitor the usage of our Service.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">To manage Your Account:</strong> to manage Your
          ...
          <li>
            <p>
              <strong class="text-white">For the performance of a contract:</strong> the
          ...
          <li>
            <p>
              <strong class="text-white">To contact You:</strong> To contact You by email, telephone
          ...
          <li>
            <p>
              <strong class="text-white">To provide You</strong> with news, special offers and
          ...
          <li>
            <p>
              <strong class="text-white">To manage Your requests:</strong> To attend and manage Your
              requests to Us.
            </p>
          </li>
          <li>
            <p>
              <strong class="text-white">For business transfers:</strong> We may use Your
          ...
          <li>
            <p>
              <strong class="text-white">For other purposes</strong>: We may use Your information
        ...
        <ul class="ms-8 list-disc mt-8 text-gray-300">
          <li>
            <strong class="text-white">With Service Providers:</strong> We may share Your personal
            information with Service Providers to monitor and analyze the use of our Service, for
            payment processing, to contact You.
          </li>
          <li>
            <strong class="text-white">For business transfers:</strong> We may share or transfer
          ...
          <li>
            <strong class="text-white">With Affiliates:</strong> We may share Your information with
          ...
          <li>
            <strong class="text-white">With business partners:</strong> We may share Your
            information with Our business partners to offer You certain products, services or
            promotions.
          </li>
          <li>
            <strong class="text-white">With other users:</strong> when You share personal
          ...
          <li>
            <strong class="text-white">With Your consent</strong>: We may disclose Your personal
            information for any other purpose with Your consent.
          </li>
        </ul>
        <h3 class="font-bold mt-8 text-white">Retention of Your Personal Data</h3>
        <p class="text-gray-300">
        ...
        <h3 class="font-bold mt-8 text-white">Transfer of Your Personal Data</h3>
        <p class="text-gray-300">
        ...
        <h3 class="font-bold mt-8 text-white">Delete Your Personal Data</h3>
        <p class="text-gray-300">
        ...
        <h3 class="font-bold mt-8 text-white">Disclosure of Your Personal Data</h3>
        <h4 class="font-semibold text-white">Business Transactions</h4>
        <p class="text-gray-300">
        ...
        <h4 class="font-semibold text-white">Law enforcement</h4>
        <p class="text-gray-300">
          Under certain circumstances, the Company may be required to disclose Your Personal Data if
          required to do so by law or in response to valid requests by public authorities (e.g. a
          court or a government agency).
        </p>
        <h4 class="font-semibold text-white">Other legal requirements</h4>
        <p class="text-gray-300">
        ...
        <h3 class="font-bold mt-8 text-white">Security of Your Personal Data</h3>
        <p class="text-gray-300">
        ...
        <h3 class="font-bold mt-8 text-white">Email Marketing</h3>
        <p class="text-gray-300">
        ...
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <p><strong class="text-white">Zoho</strong></p>
            <p>
        ...
        <h3 class="font-bold mt-8 text-white">Payments</h3>
        <p class="text-gray-300">
        ...
        <ul class="ms-8 list-disc text-gray-300">
          <li>
            <p><strong class="text-white">Stripe</strong></p>
            <p>
              Their Privacy Policy can be viewed at
              <NuxtLink
                class="text-primary-400 hover:text-primary-300 underline"
        ...
        <h2 class="font-semibold text-2xl mt-8 text-white">Contact Us</h2>
        <p class="text-gray-300">
